...
import { configureVnModeControllerDeps, setVnTrialController, trySetVisualNovelToggleInObject, trySetSillyTavernVisualNovelMode, createVnModeController } from "../vn/controller/vnModeController.js";
import { configureTrialUiControllerDeps, updateTrialUiControllerDeps, createTrialIntroOstController, createTrialDiscussionController, createNonstopDebateController, createTrialIntroUiController } from "../trial/ui/trialUiControllers.js";
import { configureGiftReactionDeps, updateGiftReactionRuntimeDeps, getGiftJudgementStore, getStoredGiftJudgement, saveGiftJudgement, setGiftJudgementCollapsed, getActiveSocialCharacter, queueGiftForNextReply, buildMessageSignature, normalizeGiftVerdict, applyGiftOutcome, injectGiftReactionBanner, injectPersistedGiftReactionForMessage } from "../social/gift/giftReactions.js";
...
configureVnModeControllerDeps({
    extensionName,
    setMonopadSetting,
    getMonopadSetting,
    saveSettingsDebounced,
    trialController,
    stripV3CMarkersFromText,
});
...
configureGiftReactionDeps({
    extension_settings,
    extensionName,
    saveSettingsDebounced,
    characters,
    activeSocialCharacterId,
    itemsPanelController,
    socialPanelController,
    decreaseTrust,
...
jQuery(async () => {
    ...
    sfx = {
        ...
        updateGiftReactionRuntimeDeps({ playSfx });
    ...
    getSetting: getMonopadSetting
        ...
        updateGiftReactionRuntimeDeps({ itemsPanelController });
        ...
        updateGiftReactionRuntimeDeps({ rewards });
        ...
        socialPanelController = createSocialPanelController({
            ...
            setActiveSocialCharacterId: value => {
                ...
                updateGiftReactionRuntimeDeps({ activeSocialCharacterId });
            },
        });
        updateGiftReactionRuntimeDeps({ socialPanelController });
...
configureTrialUiControllerDeps({
    trialController,
    sfx,
    getMonopadSetting,
    extension_settings,
...
setVnTrialController(trialController);
updateTrialUiControllerDeps({
    trialController,
    sfx,
    getMonopadSetting,
    vnModeController,
