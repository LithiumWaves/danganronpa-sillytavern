let extensionName;
let setMonopadSetting;
let getMonopadSetting;
let saveSettingsDebounced;
let trialController;
let stripV3CMarkersFromText;

export function configureVnModeControllerDeps(deps = {}) {
  extensionName = deps.extensionName;
  setMonopadSetting = deps.setMonopadSetting;
  ...
  stripV3CMarkersFromText = deps.stripV3CMarkersFromText;
}
...
export function setVnTrialController(controller) { trialController = controller; }
export { trySetVisualNovelToggleInObject, trySetSillyTavernVisualNovelMode, createVnModeController };
